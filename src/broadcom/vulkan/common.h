...
V3DVK_DEFINE_NONDISP_HANDLE_CASTS(v3dvk_buffer_view, VkBufferView)
...
V3DVK_DEFINE_NONDISP_HANDLE_CASTS(v3dvk_descriptor_set, VkDescriptorSet)
V3DVK_DEFINE_NONDISP_HANDLE_CASTS(v3dvk_descriptor_set_layout, VkDescriptorSetLayout)
V3DVK_DEFINE_NONDISP_HANDLE_CASTS(v3dvk_descriptor_pool, VkDescriptorPool)
V3DVK_DEFINE_NONDISP_HANDLE_CASTS(v3dvk_descriptor_update_template, VkDescriptorUpdateTemplate)
