...
typedef enum VkDriverIdKHR {
    ...
    VK_DRIVER_ID_BROADCOM_OPEN_SOURCE_MESA_KHR = 13,
    VK_DRIVER_ID_BEGIN_RANGE_KHR = VK_DRIVER_ID_AMD_PROPRIETARY_KHR,
    VK_DRIVER_ID_END_RANGE_KHR = VK_DRIVER_ID_BROADCOM_OPEN_SOURCE_MESA_KHR,
    VK_DRIVER_ID_RANGE_SIZE_KHR = (VK_DRIVER_ID_BROADCOM_OPEN_SOURCE_MESA_KHR - VK_DRIVER_ID_AMD_PROPRIETARY_KHR + 1),
